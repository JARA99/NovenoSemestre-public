...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\myTitle}{Examen Final}
\newcommand{\myDate}{Guatemala, mayo de 2022}
\newcommand{\myCourse}{Análisis de Variable Compleja 1}
...
\fancyhead[L]{ 
	\includegraphics[height=1.6 cm]{/home/jorgealejandro/Templates/ecfmLogoColorO.png} \\
	\textbf{Catedrático: Damián Ochoa}\\
	\textbf{Auxiliar: Jorge Rodríguez} 
	}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Encabezado - END %%%%%%%%%%
...
% \textbf{Instrucciones generales:} Desarrolle los siguientes temas de forma clara y ordenada. Posee de dos horas y media para realizar el examen. Cualquier intento de copia supondrá la anulación del examen.
